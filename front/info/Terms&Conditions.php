...
<p>Please read these Terms and Conditions ("Terms", "Terms and Conditions") carefully before using the pigtravel.top
    website (the "Service") operated by PigTravel ("us", "we", or "our").</p>
...
<p>By accessing or using the Service you agree to be bound by these Terms. If you disagree with any part of the terms
    then you may not access the Service. The Terms and Conditions agreement for PigTravel is based on the <a
            href="https://termsfeed.com/blog/sample-terms-and-conditions-template/">TermsFeed's Terms and Conditions
        Template</a>.</p>
...
<p>Our Service may contain links to third-party web sites or services that are not owned or controlled by PigTravel.</p>
<p>PigTravel has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any
    third party web sites or services. You further acknowledge and agree that PigTravel shall not be responsible or
...
<h2>Governing Law</h2>
<p>These Terms shall be governed and construed in accordance with the laws of Spain, without regard to its conflict of
    law provisions.</p>
<p>Our failure to enforce any right or provision of these Terms will not be considered a waiver of those rights. If any
    ...
    and replace any prior agreindex.htmlements we might have between us regarding the Service.</p>
