...
<section>
    <div class="container my-3">
        <h2>Reserva #<?php echo $reserva->getId() ?>
            <small><span id="estado-reserva" class="badge badge-pill"><?php echo $reserva->getNombreEstado() ?></span>
            </small>
        </h2>
        <div class="row">
            <div class="col-12">
            ...
            <div class="col-12">
                <div class="card p-3 bg-light">
                    ...
                    <div class="mt-3">
                        <h6>CLIENTE</h6>
                        <a href="/messages/<?php echo $vivienda->getID(); ?>" class="btn btn-primary col-auto my-1">CHAT
