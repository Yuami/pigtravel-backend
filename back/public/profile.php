        ...
        <div class="row">
            <div class="order-0 order-md-1 offset-md-1 col-md-3 side-menu">
                <div class="picture-container">
                    <div class="picture">
                        <img src="https://placeimg.com/250/250/people" class="picture-src" id="wizardPicturePreview" title="">
                        <input name="imgForm" type="file" id="wizard-picture" class="">
                    </div>
                    <h6 class="">Choose Picture</h6>
                </div>
                <div class="row"><input class="btn d-md-none btn-block btn-primary mt-3" type="submit" form="profileForm"/></div>
            </div>
