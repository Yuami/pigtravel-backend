...
class File
{
    ...
    public
    static function setProfileImage($id, $image)
    {
        $file = PERFIL . $id . ".png";
    ...
    public
    static function setRandomImageByName($name, $surname, $id, $size = 128)
    {
        return self::setProfileImage($id, file_get_contents("https://api.adorable.io/avatars/" . $size . "/" . $id . ".png"));
    }

    public
    static function getProfileImage($persona): string
    {
        $id = $persona->getId();
    ...
    public
    static function getProfileImageById($idPersona)
    {
    ...
    public
    static function getIMG($route, $name)
    {
    ...
    public
    static function getMainHouseImage($houseID): string
    {
